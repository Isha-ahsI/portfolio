...
export const Skill = () => {
    return (
        <>
            <section id="skills" className='relative overflow-hidden max-w-7xl mx-auto pt-24 sm:px-6 sm:pt-28 px-4'>
                ...
                <div className=' text-center flex flex-col justify-center items-center mb-12'>
                    ...
                    <motion.h1 className='font-bold text-2xl sm:text-4xl mb-2 text-primary' initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4, duration: 0.6, ease: "linear" }}>Technologies I Work With</motion.h1>
                </div>
