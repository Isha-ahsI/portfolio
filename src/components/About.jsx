...
export const About = () => {
    return (
        <section id="about" className="relative overflow-hidden max-w-6xl mx-auto pt-24 sm:px-6 sm:pt-28 px-4">
            ...
            <div className="max-w-5xl mx-auto relative flex md:flex-row items-center md:justify-between justify-center">
                ...
                {/* Content Card */}
                <div
                    className="md:z-10 md:absolute md:start-70 rounded-2xl md:pl-16 md:pr-8 px-10 py-10 border border-dark/20 dark:border-white/20 bg-primary backdrop-blur-md shadow-[0_0_30px_rgba(var(--color-primary-rgb),0.2)]"
                >
                    ...
                    <p className="text-white/75 dark:text-white/75 leading-relaxed mb-8">
                        I'm a passionate
